...
def convert_format(input_file, output_file):
    ...
    try:
        ...
        for item in data:
            transformed_item = {
                "model": "events.municipality",
                "pk": item["id"],
                "fields": {
                    "name": item["name"],
                    "district": item["district_id"],
                    "municipality_type": item["category_id"],
                    "area_sq_km": item["area_sq_km"],
                    "website": item["website"],
                    "no_of_wards": item["wards"]
                }
            }
...
convert_format('/home/atreya/Projects/micro-mis/backend/scripts/municipalities_input.json', '/home/atreya/Projects/micro-mis/backend/scripts/municipalities_output.json')
